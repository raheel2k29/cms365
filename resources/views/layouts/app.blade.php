...
<aside class="sidebar">
    ...
    <nav class="sidebar-nav">
        ...
        <a href="{{ route('quotes.index') }}" class="nav-item {{ request()->routeIs('quotes.index') || request()->routeIs('quotes.show') || request()->routeIs('quotes.edit') || request()->routeIs('quotes.create') ? 'active' : '' }}">
        ...
        <a href="{{ route('quotes.calendar') }}" class="nav-item {{ request()->routeIs('quotes.calendar') ? 'active' : '' }}" style="padding-left: 46px; font-size: 12.5px;">
